...
@section('mainContent')
	<div class="row">
		<div class="col-md-12">
			<p><a class="btn btn-success" href="{{ route('author.add-post') }}">Add Post</a></p>
					...
					<tr>
                        ...
                        <td>
                           ...
                           @endif
                            ...
                            <form id="delete-data-{{ $post->id }}" action="{{ route('author.delete-post', ['id'=>$post->id]) }}" method="POST" style="display:none; ">
                                @csrf
                            </form>
                        </td>
					</tr>
