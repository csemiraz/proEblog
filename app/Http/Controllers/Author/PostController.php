...
class PostController extends Controller
{
    public function managePost()
    {
    	...
    	return view('back-end.author.post.manage-post', compact('posts'));
    }
    ...
    public function addPost()
    {
    	...
    	$tags = Tag::all();
    	return view('back-end.author.post.add-post', [
    ...
    public function editPost($id)
    {
    	...
    	$tags = Tag::all();
    	$post = Post::find($id);
    	return view('back-end.author.post.edit-post', [
    		'categories' => $categories,
    		'tags' => $tags,
    		'post' => $post,
    	]);
    ...
    {
    	$post = Post::find($id);
    	return view('back-end.author.post.details-post',[
    		'post' => $post,
    	]);
    }
